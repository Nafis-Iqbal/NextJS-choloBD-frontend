...
export default function DashboardPage() {
    return (
        <div className="flex flex-col p-2 space-y-2 justify-center w-full font-sans" style={{backgroundColor: 'var(--theme-section-bg)', color: 'var(--theme-text)'}}>
            <h1 className="ml-6 mt-20">Dashboard</h1>
            <p className="ml-6 theme-text-subtle">Welcome back. Let's get things done.</p>
