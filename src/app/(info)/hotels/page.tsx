...
function HotelListingsPage() {
    ...
    const {data: hotelsData, isLoading: isFetchLoading, isError: isFetchError, refetch: refetchHotels} = HotelApi.useGetAllHotelsRQ(queryString);
    ...
    return (
        <div className="flex flex-col p-2 font-sans mt-5">
            <div className="md:ml-6 flex flex-col space-y-2">
                ...
                <p className="text-green-200">"All hotels listed here."</p>
                    ...
                    <div className="overflow-x-auto w-full">
                        <div className="min-w-[900px]">
                            <div className="flex border-1 border-green-800 p-2 bg-gray-600 text-center">
                                ...
                                <p className="w-[30%]">Hotel Image</p>
                                <p className="w-[15%]">Hotel Type</p>
                                <p className="w-[10%]">Rating</p>
                                <p className="w-[10%]">Available Rooms</p>
                                ...
                                {(hotels ?? []).map((hotel, index) => {
                                    return (
                                        <HotelViewListTableRow 
                                            ...
                                            onClickNavigate={() => router.push(`/hotel/${hotel.id}`)}
                                        />
                                    );
                                })}
                            </div>
