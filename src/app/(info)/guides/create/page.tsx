    ...
    return (
        <div className="flex flex-col p-2 mt-5">
            <div className="flex flex-col space-y-2 font-sans mx-auto">
                <h3 className="theme-label">Create New Guide</h3>
                <p className="theme-text-muted">Add a new guide profile to the platform.</p>

                <GuideForm mode="create" editMode="MASTER_ADMIN" />
            </div>
        </div>
    );
}
